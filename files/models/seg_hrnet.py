...
def hrnet_w18(dataset,pretrained=False):
    import yaml
    from utils.mypath import PROJECT_ROOT_DIR
    hrnet_cfg = os.path.join(PROJECT_ROOT_DIR, 'files','models', 'yml',dataset,'hrnet18', 'hrnet_w18.yml')
    ...
    if pretrained:
        pretrained_weights = os.path.join(PROJECT_ROOT_DIR, 'files','models','pth', 'hrnet_w18_small_model_v2.pth')
